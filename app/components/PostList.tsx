        ...
        <ul className="">
          ...
          >
            <motion.article
              ...
              viewport={{ once: true }}
              className="bg-white dark:bg-secondary rounded-2xl p-2 flex flex-col sm:flex-row items-center w-ull sm:w-[95%] mx-auto gap-2 md:gap-7 shadow-md md:shadow-lg"
            >
